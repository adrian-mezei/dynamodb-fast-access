...
export function DBComposite<EntityModel, EntityRawModel>(
    ...
    return class DBComposite extends DB<EntityModel, EntityRawModel>(tableName, extend, deleteRelated) {
        public static async queryRecurseRaw(
        ...
        public static async queryRecurse(
            partitionKeyValue: string,
            exclusiveStartKey?: string,
        ): Promise<EntityModel[]> {
        ...
        public static async queryBeginsWithRecurseRaw(
            partitionKeyValue: string,
            sortKeyBeginsWithValue?: string,
            exclusiveStartKey?: string,
        ): Promise<EntityRawModel[]> {
            const queryParams = DBComposite._getBeginsWithQueryParameter(
                partitionKeyValue,
        ...
        public static async queryBeginsWithRecurse(
            partitionKeyValue: string,
            sortKeyBeginsWithValue?: string,
            exclusiveStartKey?: string,
        ): Promise<EntityModel[]> {
            const rawEntities = await DBComposite.queryBeginsWithRecurseRaw(
                partitionKeyValue,
                sortKeyBeginsWithValue,
                exclusiveStartKey,
            );
        ...
        public static async queryBeginsWithRaw(
            partitionKeyValue: string,
            sortKeyBeginsWithValue?: string,
            exclusiveStartKey?: string,
        ): Promise<ListModel<EntityRawModel>> {
            const queryParams = DBComposite._getBeginsWithQueryParameter(
                partitionKeyValue,
                sortKeyBeginsWithValue,
                exclusiveStartKey,
        ...
        public static async queryBeginsWith(
            partitionKeyValue: string,
            sortKeyBeginsWithValue?: string,
            exclusiveStartKey?: string,
        ): Promise<ListModel<EntityModel>> {
            const data = await DBComposite.queryBeginsWithRaw(
                partitionKeyValue,
                sortKeyBeginsWithValue,
                exclusiveStartKey,
            );
        ...
        public static _getBeginsWithQueryParameter(
            partitionKeyValue: string,
            sortKeyBeginsWithValue?: string,
            exclusiveStartKey?: string,
        ...
        public static _getQueryParameter(
            partitionKeyValue: string,
            exclusiveStartKey?: string,
        ): DynamoDB.DocumentClient.QueryInput {
            const tableName = DBComposite.getTableName();
        ...
        public static async _queryRecurseNative(
