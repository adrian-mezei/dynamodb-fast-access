...
export function DBCompositeMutable<EntityModel, EntityRawModel, EntityUpdateModel>(
    ...
    @StaticImplements<IDBCompositeMutable<EntityModel, EntityRawModel, EntityUpdateModel>>()
    class DBCompositeMutable extends DB<EntityModel, EntityRawModel>(tableName, extend, deleteRelated) {
        // Mutable extension
